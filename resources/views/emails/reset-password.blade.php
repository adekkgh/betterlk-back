...
<head>
    ...
    <title>Сброс пароля — BetterLK</title>
</head>
    ...
    <tr><td align="center" style="padding:0 20px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;">
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr><td style="padding:40px 44px 44px;">
                                    ...
                                    <p style="font-size:15px;color:#8888a0;text-align:center;line-height:1.7;margin:0 0 32px 0;">
                                        Получили запрос на изменение пароля<br>вашего аккаунта в BetterLK
                                    </p>
              ...
              <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
                href="{{ $url }}" style="height:52px;v-text-anchor:middle;width:240px;"
              ...
              <span style="display:inline-block;background-color:#221a06;border:1px solid #7a5a0a;border-radius:20px;padding:7px 22px;font-size:13px;font-weight:600;color:#f59e0b;">
                ⏱&nbsp; Ссылка действительна {{ $minutes ?? 60 }} минут
              </span>
                                            </td></tr>
                                    </table>
                                    ...
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:12px;">
                                        <tr><td style="background-color:#1f0a0a;border:1px solid #5a1a1a;border-radius:10px;padding:14px 18px;">
                                                <p style="font-size:13px;color:#f87171;line-height:1.65;margin:0;">
                                                    ...
                                                    Ваш пароль останется прежним и никто не получит доступ к аккаунту.
                                                </p>
                                            </td></tr>
                                    </table>
